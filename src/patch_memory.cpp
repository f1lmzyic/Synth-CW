...
void patchLoadDefault() {
    ...
    sysState.params.arpEnabled = false;
    sysState.params.arpMode = ARP_UP;
    sysState.params.arpRate = 64;
    sysState.params.arpOctaves = 0;

    sysState.params.chordEnabled = false;
    sysState.params.chordType = CHORD_MAJOR;
    sysState.params.chordInversion = 0;
    sysState.params.chordSpread = 0;

    sysState.params.autoRecEnabled = false;
    sysState.params.autoPlayEnabled = false;
    sysState.params.autoLength = 8;
    sysState.params.autoWriteMask = 15;
    currentPatchSlot = 0;
}
